...
def _welcome_text(first_name: str) -> str:
    return (
        ...
        "🛍 У магазині вже є кілька товарів: рибальський аксесуар, худі, кепка та стікери. "
        "Натисніть <b>«🛒 Відкрити магазин»</b>, щоб переглянути каталог і оформити замовлення.\n\n"
        "🏪 Самовивіз доступний лише в <b>Хмельницькому</b>, від <b>5 штук</b> і за домовленістю.\n\n"
